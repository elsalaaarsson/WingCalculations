...
C_f_fuselage = drag_coeff_skin(Re_crit, rho_air, mu_air, v_cruise, c, S_wet_fuselage, S_ref_fuselage);
C_f_VTOL_motors = drag_coeff_skin(Re_crit, rho_air, mu_air, v_cruise, c, S_wet_VTOL_motors, S_ref_VTOL_motors);
